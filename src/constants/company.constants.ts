...
export const CompanyConstants = {
  ...
  LINKEDIN: 'https://www.linkedin.com/company/rowad-for-software-development',
  FACEBOOK: 'https://facebook.com/rowad',
  LOCATION: '584 El-Horreya Road, Gleem, Alexandria, Egypt',
